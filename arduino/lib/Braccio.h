...
public:
  ...
  */
  ...
  /**
   * This function allow the user to control all the servo motors except for the one that operates the gripper.
   */
  int ServoMovement(int delay, int Vbase,int Vshoulder, int Velbow, int Vwrist_ver, int Vwrist_rot);

  /**
   * This function allow the user to control the gripper servo.
   */
  int GripperMovement(int stepDelay, int Vgripper);
